...
class SubstitutionProcessor:
   ...
   def _pattern_substitution(
        ...
        **params
        ...
        Args:
            patterns: [{'pattern': '서울|경기', 'value': '수도권', 'mode': 'whole'}]
            mode: 'whole' (전체 교체) 또는 'partial' (부분 교체)
        """
        ...
        for pattern_dict in patterns:
            ...
            mode = pattern_dict.get('mode', 'whole')  # 기본값: 전체 교체
            ...
            try:
                if mode == 'whole':
                    ...
                    # 새로운 방식: 매칭된 부분만 교체
                    result = result.str.replace(pattern, replace_value, regex=True)
